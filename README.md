<img src="https://capsule-render.vercel.app/api?type=waving&color=0:000000,100:00FF88&height=230&section=header&text=HAMID.py&fontSize=62&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=%3E+Python+Developer+%7C+Linux+%7C+Security+Learner&descAlignY=60&descAlign=50&descSize=20" />
...
class Hamid:
    ...
    os = ["Linux", "Bash", "Git"]
    net = ["Network+", "TCP/IP", "DNS", "DHCP"]
    obsession = ["Cybersecurity", "Hacking", "IoT"]
...
- 🔭 Building **Linux automation tools in Python**
- 🛡️ Learning path: **Python → Linux → Network+ → Pentest**
- 💡 I automate boring stuff: WiFi, keyboard, system tasks
- ⚡ Fun fact: **I learn by breaking**

</td>
<td width="40%" align="center">
  <img src="https://user-images.githubusercontent.com/74038190/229223263-cf2e4b07-2615-8f32-6d21-902750a1b8fb.gif" width="100%" />
  <br/><br/>
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=python,html,css,c,cpp,linux,bash,git,github,vscode,arduino&theme=dark" />
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Network+-000000?style=for-the-badge&logo=cisco&logoColor=00ff88" />
  <br/>
...
### 🧪 Cyber Lab — where I'm going

```bash
Python ██████████░░ 80%  # OOP, files, automation
Linux  ████████░░░░ 65%  # bash, services, permissions
HTML/CSS ███████░░░ 60%
Network+ ██████░░░░ 50%  # TCP/IP, subnetting, DNS
C/C++  ████░░░░░░░ 35%
Hacking ███░░░░░░░░ 25%  # TryHackMe next →
```

- [x] Python scripts that actually run on Linux
- [ ] TryHackMe: Pre-Security → Jr Pentester
- [ ] Wireshark + Nmap + Burp basics
- [ ] IoT with Arduino
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:000000,100:00FF88&height=130&section=footer" />
